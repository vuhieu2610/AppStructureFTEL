...
namespace FTEL.Common.Security
{
    public class EncryptCore
    {
        public static readonly string KeyEncrypt = "!@$v@1022cdf|";
        public static readonly string PassKey = "tinguyen@123!";
        ...
        {
            var tokenCode = Libs.GetMd5(userId + PassKey);
            return tokenCode;
        }
