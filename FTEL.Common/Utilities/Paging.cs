...
namespace FTEL.Common.Utilities
{
    public class Paging
    {
        //Source: http://www.mostefaiamine.com/post/2013/10/26/Creating-an-adaptive-pager-using-ASPNET-MVC-4-HTML-helpers-and-Twitter-Bootstrap-3
        public static string RenderPager(int recordNumber, int currentPage, int pageSize)
        {
            if (currentPage == 0)
            {
                currentPage = 1;
            ...
            if (currentPage > 1)
            {
                AppendPagerTag(builder, currentPage - 1, currentPage, "Prev"); // Hiện icon trang trước khi trang hien tai > 1
            }
            ...
            {
                AppendPagerTag(builder, currentPage + 1, currentPage, "Next"); //Hien icon trang sau
            }
        ...
        public static string RenderPagerAjax(int recordNumber, int currentPage, int pageSize)
        {
            if (currentPage == 0)
            {
                currentPage = 1;
            ...
            if (currentPage > 1)
            {
                AppendPagerTagAjax(builder, currentPage - 1, currentPage, "Prev"); // Hiện icon trang trước khi trang hien tai > 1
            }
            ...
            if (currentPage < numberOfPages)
            {
                AppendPagerTagAjax(builder, currentPage + 1, currentPage, "Next"); //Hien icon trang sau
            }
            builder.AppendFormat("</ul>");
            return builder.ToString();
        }
